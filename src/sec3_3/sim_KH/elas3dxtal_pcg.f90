...
!------------------------------------------------------------------------------  
      module elas3d_mod
       ...
       real(dp), parameter :: C11_local = 206.00d9   ! (Pa)
       real(dp), parameter :: C12_local = 133.00d9   ! (Pa)
       real(dp), parameter :: C44_local = 119.00d9   ! (Pa)     	   
       ...
       real(dp), parameter :: aml_exx =  aml
       real(dp), parameter :: aml_eyy =  0.00d0       
       real(dp), parameter :: aml_ezz =  0.00d0   
...
!-------------------------------------------------------------------------
      ...
      do ijk = 1, ldemb
        ...
        ! --- CHECK FOR DIVERGENCE (one order of magnitude increase) ---
